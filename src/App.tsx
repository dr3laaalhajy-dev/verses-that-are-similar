        ...
        {view === 'admin' ? (
          ...
          <AnimatePresence mode="wait">
            {showScores ? (
              ...
              >
                <div className="flex items-center justify-between">
                  <h2 className="text-4xl font-black text-brand-emerald flex items-center gap-4">
                    <LayoutGrid className="w-10 h-10 text-brand-gold" />
                    اختر مسابقة التحدي
                  </h2>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {challenges.map((c, idx) => (
                    <motion.button
                      ...
                      className="group p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-xl hover:shadow-2xl hover:border-brand-emerald/30 transition-all text-right flex flex-col justify-between min-h-[220px]"
                    >
                      <div>
                        <div className="text-xs font-black text-brand-gold uppercase tracking-widest mb-3">مسابقة #{c.id}</div>
                      ...
                      <div className="mt-6 flex items-center justify-end">
                        <div className="w-12 h-12 rounded-2xl bg-brand-emerald/5 flex items-center justify-center group-hover:bg-brand-emerald group-hover:text-white transition-all">
